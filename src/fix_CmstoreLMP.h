#ifndef FIX_CMSTORELMP_H
#define FIX_CMSTORELMP_H
...
namespace MASKE_NS {
	...
	class Fix_CmstoreLMP : protected Pointers {
	public:
        Fix_CmstoreLMP(class MASKE *);
		~Fix_CmstoreLMP();
        ...
        void execute(int,int);  // function executing fix of this type
        void printall();
